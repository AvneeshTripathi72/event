...
export const WHY_CHOOSE_FEATURES = [
  {
    icon: "✨",
    title: "Handpicked for You",
    desc: "We don't just provide artists; we curate experiences. Magnevents provides carefully selected singers, bands, and musicians based on your event style, audience, and budget.",
    accent: "matrix"
  },
  {
    icon: "📅",
    title: "Hassle-Free Booking",
    desc: "From initial inquiry to the final performance, we handle everything. Mention services like hiring singers for house parties, Sufi singers in Delhi, or wedding bands—we make it simple.",
    accent: "pink"
  },
  {
    icon: "🔊",
    title: "Complete Entertainment Setup",
    desc: "Zero stress for you. We provide end-to-end management, including professional sound setups, stage coordination, and technical support to ensure a flawless show.",
    accent: "matrix"
  }
]
